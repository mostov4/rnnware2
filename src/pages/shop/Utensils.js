...
import TabProductTwelveUtensils from "../../wrappers/product/TabProductTwelveUtensils";

const Utensils = ({ products }) => {
    const [layout, setLayout] = useState('grid three-column');
    const [sortType, setSortType] = useState('category');
    const [sortValue, setSortValue] = useState('Utensils');
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>RNN-Ware | Utensils</title>
            </MetaTags>

            <LayoutOne headerTop="visible">

                <TabProductTwelveUtensils
                    category="Utensils"
                    spaceTopClass="pt-40"
...
export default connect(mapStateToProps)(Utensils);