...
import TabProductTwelveStorage from "../../wrappers/product/TabProductTwelveStorage";

const Storage = ({ products }) => {
    const [layout, setLayout] = useState('grid three-column');
    const [sortType, setSortType] = useState('category');
    const [sortValue, setSortValue] = useState('Storage');
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>RNN-Ware | Storage</title>
            </MetaTags>

            <LayoutOne headerTop="visible">

                <TabProductTwelveStorage
                    category="Storage"
                    spaceTopClass="pt-40"
