...
import TabProductTwelveDine from "../../wrappers/product/TabProductTwelveDine";

const Storage = ({ products }) => {
    const [layout, setLayout] = useState('grid three-column');
    const [sortType, setSortType] = useState('category');
    const [sortValue, setSortValue] = useState('Dine');
    ...
    return (
        <Fragment>
            <MetaTags>
                <title>RNN-Ware | Dine</title>
            </MetaTags>

            <LayoutOne headerTop="visible">

                <TabProductTwelveDine category={"Dine"} spaceTopClass="pt-40"/>
